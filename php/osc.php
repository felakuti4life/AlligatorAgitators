...
//a test message
$DEBUG = true;
$test_msg = new OSCMessage('test', [1]);

$f_agit_up = new OSCMessage('f_agit', [1]);
$f_agit_down = new OSCMessage('f_agit', [0]);
$g_agit_up = new OSCMessage('g_agit', [1]);
$g_agit_down = new OSCMessage('g_agit', [0]);

$f_chat_up = new OSCMessage('f_chat', [1]);
$f_chat_down = new OSCMessage('f_chat', [0]);
$g_chat_up = new OSCMessage('g_chat', [1]);
$g_chat_down = new OSCMessage('g_chat', [0]);

$f_left_up = new OSCMessage('f_left', [1]);
$f_left_down = new OSCMessage('f_left', [0]);

$f_right_up = new OSCMessage('f_right', [1]);
$f_right_down = new OSCMessage('f_right', [0]);

$f_left_added = new OSCMessage('f_left_add', [1]);
$f_right_added = new OSCMessage('f_right_add', [1]);
$score_add = new OSCMessage('score_add', [1]);
$f_left_mov_left = new OSCMessage('lml', [1]);
$f_left_mov_right = new OSCMessage('lmr',[1]);
$f_right_mov_left = new OSCMessage('rml',[1]);
$f_right_mov_right = new OSCMessage('rmr',[1]);

$osc = new OSCClient('localhost', 9900);
//start off with some test msgs on load
if ($DEBUG) {
    $osc->send($test_msg);
}
